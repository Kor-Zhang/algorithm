...
public class DoubleLinkedList<E> extends AbstractList<E> {
	...
	public static void main(String[] args) {
		...
		try {
			/*
			 * long s = System.currentTimeMillis(); for(int i = 0;i<20000;i++){
			 * l.add(i); } l.clear(); for(int i = 0;i<20000;i++){
			 * l.removeElement(i); }
			 * System.out.println("用时:"+(System.currentTimeMillis() -s));
			 */
			/*
			 * for(int i = 0;i<20000;i++){ l.add(i); } for (int i = 0; i <
			 * 20000; i++) { System.err.println(l.get(i)); }
			 */
			// l.add(11);
			// l.add(121);
			// l.add(1211);
